...
=======
        <Image src="/gllry2.webp" alt="Lhasa City" width={350} height={250} className="w-full h-full object-cover" />
        <Image src="/gllry1.jpg" alt="Potala Palace" width={350} height={250} className="w-full h-full object-cover" />
        <Image src="/lhasa.jpg" alt="Lake Mansarovar" width={350} height={250} className="w-full h-full object-cover" />
        <Image src="/lahasa1.jpeg" alt="Mount Kailash" width={350} height={250} className="w-full h-full object-cover" />
>>>>>>> 827b76d2b779c11277137b6cb34164097e9037ef
      </motion.div>
