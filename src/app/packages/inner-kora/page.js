            ...
            >
              ...
              >
                ...
                <p className="mt-4 text-gray-700 text-base leading-relaxed">
                  The Inner Kora Kailash Tour is a sacred pilgrimage around the
                  base of Mount Kailash, one of the most revered and spiritually
                  significant sites in the world. This trek offers a deep
                  spiritual experience for travelers, taking them through
                  stunning landscapes, ancient monasteries, and sites that are
                  deeply embedded in the beliefs of multiple religions such as
                  Hinduism, Buddhism, Jainism, and Bon.
                </p>

                <p className="mt-2 text-gray-700 text-base leading-relaxed">
                  The Inner Kora is a 3-day trek that covers approximately 32
                  kilometers, allowing pilgrims to circumnavigate Mount Kailash,
                  the spiritual heart of Tibet. It is said that completing the
                  trek is a way to purify the soul, cleanse karma, and bring
                  peace and prosperity into one’s life. The journey is
                  challenging due to the high altitude and rugged terrain, but
                  it is a life-changing experience for those seeking spiritual
                  growth and connection to the sacred land.
                </p>
                ...
                <div className="mt-6 grid grid-cols-2 gap-3 text-gray-800 text-xs font-medium">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <p>
                      <strong>Mode of Travel:</strong> Trekking
                    </p>
                  </div>
                  <div className="flex items-center space-x-1">
                    <span className="text-lg">🌕</span>
                    <p>
                      <strong>Best Time:</strong> May to September
                    </p>
                  </div>
                  <div className="flex items-center space-x-1">
                    <span className="text-lg">🌍</span>
