  ...
  <div className="bg-gray-50 py-10 px-4 md:px-8">
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
      >
        <Image src="/moon.jpg" alt="Lhasa City" width={350} height={250} className="w-full h-full object-cover" />
        <Image src="/moon1.jpg" alt="Lake Mansarovar" width={350} height={250} className="w-full h-full object-cover" />
        <Image src="/moon2.jpg" alt="Mount Kailash" width={350} height={250} className="w-full h-full object-cover" />
        <Image src="/FullMoon.webp" alt="Mount Kailash" width={350} height={250} className="w-full h-full object-cover" />
      </motion.div>
>>>>>>> 827b76d2b779c11277137b6cb34164097e9037ef
      ...
      >
        ...
        Kailash Full Moon Trek
        </h2>

        <p className="mt-4 text-gray-700 text-base leading-relaxed">
  The Kailash Full Moon Trek is a once-in-a-lifetime spiritual journey that takes you to the sacred Mount Kailash, under the mystic glow of the full moon. This trek offers an unparalleled experience, with the moonlight casting a serene light over the holy landscapes. Pilgrims trek around Kailash, believed to be the abode of Lord Shiva, while immersed in the spiritual energy of the moonlit surroundings.
</p>
<p className="mt-2 text-gray-700 text-base leading-relaxed">
  As you walk across the rugged Tibetan plateau, the trek offers breathtaking views of snow-capped peaks and sacred lakes, all under the shimmering full moon. The experience is not only physically challenging but deeply transformative, allowing pilgrims to reflect and connect spiritually with the universe in a way that is only possible during this unique time.
</p>
...
<div className="mt-6 grid grid-cols-2 gap-3 text-gray-800 text-xs font-medium">
  <div className="flex items-center space-x-1">
    ...
    <p><strong>Duration:</strong> 11 Days</p>
  </div>
  <div className="flex items-center space-x-1">
    <span className="text-lg">⛰</span>
  ...
  <div className="flex items-center space-x-1">
    <span className="text-lg">🌕</span>
    <p><strong>Best Time:</strong> Full Moon Period</p>
  </div>
  <div className="flex items-center space-x-1">
    <span className="text-lg">🌍</span>
...
=======
        ...
        <div className="mt-5 flex flex-col md:flex-row md:space-x-3 space-y-2 md:space-y-0">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            className="w-full md:w-auto px-4 py-1 bg-yellow-500 text-white text-sm font-medium rounded-md shadow-md flex items-center justify-center space-x-2 transition-all hover:bg-yellow-600"
          >
...
>>>>>>> 827b76d2b779c11277137b6cb34164097e9037ef
  Kailash Full Moon Trek Itinerary
  </h2>
